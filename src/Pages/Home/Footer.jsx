  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src={`${process.env.PUBLIC_URL}/logo.png`} alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/rushikesh-sapkal96"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Rushikesh</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
